...
{
    public class AddServiceImplementationWithBuilder : IDisposable
    {
        private readonly TestRunValues _testRunValues;
        private readonly Channel _channel;
        private readonly SampleServiceClient _client;

        public AddServiceImplementationWithBuilder()
        {
        ...
        [Fact]
        public async Task AddingAServiceImplementationWithBuilderHostsAndHandlesRequests()
        {
            //arrange
            var serverHostBuilder = new HostBuilder()
               .ConfigureServices((hostContext, services) =>
               {
                   ...
                   services.AddGrpcServer(
                       builder => builder.AddService<DumbPipeServiceImplementation>(), 
                       new[] { new ServerPort(_testRunValues.Host, _testRunValues.Port, _testRunValues.ServerCredentials) }
                   );
               });
